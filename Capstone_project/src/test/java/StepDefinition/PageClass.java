...
public class PageClass {
   ...
   // Locators for Filter,offers,OderReceipt,Privacy policy, ContinueBtn,Search,Orders
    ...
    public void Login_imgnot() throws InterruptedException {      
        driver.findElement(signin).click();
        Thread.sleep(5000);
        driver.findElement(usernameField).click();
    ...
    public void Login_Exist() throws InterruptedException {      
        driver.findElement(signin).click();
        Thread.sleep(5000);
        driver.findElement(usernameField).click();
    ...
    public void Login_favuser() throws InterruptedException {      
        driver.findElement(signin).click();
        Thread.sleep(5000);
        driver.findElement(usernameField).click();
    ...
    public void Login_locked() throws InterruptedException {      
        driver.findElement(signin).click();
        Thread.sleep(5000);
        driver.findElement(usernameField).click();
